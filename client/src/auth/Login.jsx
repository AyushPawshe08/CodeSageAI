...
const Login = ({ email, password, setEmail, setPassword, onSubmit, onSwitchMode, loading }) => {
    return (
        <form
            onSubmit={onSubmit}
            style={{
        ...
        >
            <div>
                ...
                <p style={{ color: 'var(--text-body)', fontSize: '14px', lineHeight: 1.6 }}>
                    Use the same email and password you registered with, then jump straight into the reviewer.
                </p>
            </div>
